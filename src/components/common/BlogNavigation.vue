<template>
	<div id="BlogNavigation">
		...
		<div class="record">
			<div style="text-align: center; margin-top: 20px; position: relative;"><a href="http://blog.qxbase.com/" target="_self" class="reference-link">© qxBase博客 | 致力于互联网行业 | 软件分享 | 技术教程 | qxBase.com</a></div>
