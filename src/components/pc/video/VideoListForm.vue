<template>
	<div id="videoList">
		<el-card class="videoListCard">
			<span style="margin-top: -12px; margin-left: -10px; position: absolute; font-size: 15px; color: #FC8BBB;" type="text">热门动漫</span>
			<el-button style="float: right; top: -15px; left: 5px; position: relative; padding: 3px 0; font-size: 15px;" type="text" disabled>更多</el-button>
			<div class="video-card-wrapper">
				<el-card v-for="(item, i) in videoPage.list" :key="i" class="videoCard" :body-style="{ padding: '0px' }">
				  ...
				  <div style="padding: 2px;">
					...
					<span style="font-size: 11px; opacity: 0.7; position: relative; float: right;">最新：第{{ item.videoEpisodes[item.videoEpisodes.length - 1].episode }}集</span>
				  </div>
				</el-card>
			</div>
		</el-card>
