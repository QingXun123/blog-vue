    ...
    <el-card class="box-card loginCard" v-loading="loading">
      <div v-if="currentContent === 'login'">
        <div class="inputList">
          ...
          <el-input placeholder="请输入密码" v-model="password" show-password style="top: 50px;"
                    class="inputForm"></el-input>
          <el-button type="primary" style="top: 250px; position: absolute; width: 200px;" @click="login">登录
          </el-button>
        </div>
        <div class="extraList">
      ...
      <div v-else-if="currentContent === 'register'">
        <div class="inputList2">
          ...
          <el-input placeholder="请输入密码" v-model="password" show-password style="top: 20px;"
                    class="inputForm"></el-input>
          <div
              style="display: flex; align-items: center; justify-content: space-evenly; position: absolute; top: 240px;">
          ...
          <el-button type="primary" style="top: 300px; position: absolute; width: 200px;" @click="register">注册
          </el-button>
        </div>
        <div class="extraList">
