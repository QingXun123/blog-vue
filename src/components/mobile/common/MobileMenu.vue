  ...
  <div id="MobileMenu">
    ...
    <el-drawer
      ...
      <el-menu default-active="1">
        <el-menu-item index="1" @click="login" v-if="!isLogin()"
        ...
        <el-submenu index="3">
          ...
          <el-menu-item index="3-1"><a href="https://github.com/QingXun123" target="_blank">GitHub仓库</a>
          </el-menu-item>
...
<script>
import {userInfo, userLogout} from "@/api/user/user";
