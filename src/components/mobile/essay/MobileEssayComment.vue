      ...
      <div class="commentList">
        <div>
          ...
          <div class="oneComment" v-for="(comment, index) in commentList" :key="index - 1">
            ...
            <el-dropdown v-if="isLogin() && user.userId === comment.userId"
                         @command="dialogVisible = true; tempDeleteCommentId = comment.commentId;" trigger="click"
            ...
            <div class="nextCommentList">
              <div class="nextComment" v-for="(nextComment, index2) in nextCommentList[comment.commentId]"
                ...
                <el-dropdown v-if="isLogin() && user.userId === nextComment.userId"
                             @command="dialogVisible = true; tempDeleteCommentId = nextComment.commentId;"
            ...
            for (let i = 0; i < this.commentList.length; i++) {
              ...
              getNextCommentPage({
                ...
                "records": [
                  ...
                  (response) => {
                    const res = response.data;
                    // this.nextCommentPage[commentId] = res.data;
                    this.$set(this.nextCommentPage, commentId, res.data);
